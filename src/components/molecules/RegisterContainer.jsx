...
const RegisterContainer = () => {
  return (
    <div className="w-[350px] h-[250px] md:w-[450px] md:h-[600px]">
      ...
      ></img>
      <h1 className="absolute mx-24 my-6 font-bold md:text-xl md:ml-[130px] md:mt-[50px]">
        SMP ISLAM ASQOLAN <br></br>BOARDING SCHOOL
      </h1>
      <img
        src=".\src\assets\sekolah3.jpg"
        className="object-cover size-full rounded-xl shadow-2xl border-2 border-hijau1"
      ></img>
    </div>
  );
};
